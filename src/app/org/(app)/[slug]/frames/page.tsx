...
export default function FramesPage() {
    ...
    const frames = useQuery(api.frames.listByOrganization, { organizationId: org._id });
    ...
    const handleDuplicate = async (id: string) => {
        await duplicateFrame({ id: id as Id<'frames'>, organizationId: org._id });
    };
        ...
        <div className="p-6">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage display frames in {org.name}</p>
                </div>
