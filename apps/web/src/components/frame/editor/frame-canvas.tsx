...
const VERTICAL_GRID_LINES = Array.from({ length: GRID_COLS + 1 }, (_, index) => index * DEFAULT_CELL_SIZE);
const HORIZONTAL_GRID_LINES = Array.from({ length: GRID_ROWS + 1 }, (_, index) => index * DEFAULT_CELL_SIZE);
