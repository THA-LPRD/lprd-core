...
export default defineSchema(
    {
        ...
        pluginSiteAccess: defineTable({
            ...
            updatedBySite: v.optional(v.id('users')),
            createdAt: v.number(),
            updatedAt: v.number(),
        })
            .index('by_plugin', ['pluginId'])
            .index('by_site', ['siteId'])
            .index('by_plugin_and_site', ['pluginId', 'siteId']),
        ...
        pluginData: defineTable({
            ...
            .index('by_plugin_site_topic_entry', ['pluginId', 'siteId', 'topic', 'entry']),
...
); // TODO: Remove after data migration — allows old docs to coexist
